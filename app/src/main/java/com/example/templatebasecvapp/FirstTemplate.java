...
public class FirstTemplate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_template);
        setViewContent();
    }
    ...
    private void ShowData(User user, List<UserHobby> userHobbyList, List<UserSkill> userSkillList, List<UserEducation> userEducationList, List<UserProject> userProjectList, List<UserJob> userJobList) {
        ...
        htmlContent.append("<!DOCTYPE html>\n" +
                ...
                "<td>"+
                "<img width=\"100\" height=\"100\"  src=\"data:image/png;base64,"+user.getUserPciture()+"\" alt=\"No image\">"+
                "</td>"+
                "<td>"+
        ...
        if (userSkillList.size()>0) {
            htmlContent.append(
                    "<table style=\"text-align: center;\" border=\"1\" width=\"100%\">"+
                            "<thead style=\"background-color: black;color: white;width: 100%;\">"+
                            "<tr>"+
